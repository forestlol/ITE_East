<template>
    <div class="container">
        <h2 class="text-center mb-4">VERTICAL TRANSPORT ROOM [B05-15 & 16]</h2>
            ...
            <div class="col-lg-12 section-container">
                ...
                <div class="floorplan-container">
                    <div class="floorplan-image-container">
                        <img :src="floorplanImage" alt="Floorplan for B05-15 & 16" class="floorplan-image" />
                    </div>
                </div>
            </div>
        </div>
...
export default {
    data() {
        return {
            ...
            floorplanImage: require('@/assets/Sub System and Icons/V2/B05 15-16_full.png') // Replace with the correct image path
        };
    },
    methods: {
        openPopupWindow() {
    ...
    `);
        ...
        async fetchSensorData() {
            try {
                ...
                const sensorData = response.data.find(sensor => sensor.devEUI === "24e124710d481996");
                if (sensorData && sensorData.data) {
                    ...
                    console.error("Sensor with devEUI '24e124710d481996' not found or missing data.");
                }
            } catch (error) {
