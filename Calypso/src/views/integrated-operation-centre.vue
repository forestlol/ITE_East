...
export default {
    data() {
        return {
            ...
            toggleDevices: [
                { name: 'MCD 3', isOnline: false, deviceEUI: '24E124756E049153', top: '38%', left: '65%' },  // Initially ON
    ...
    `);
        ...
        async fetchSensorData() {
            try {
                ...
                const sensorData = response.data.find(sensor => sensor.devEUI === "24e124710d480176");
                if (sensorData && sensorData.data) {
                    ...
                    console.error("Sensor with devEUI '24e124710d480176' not found or missing data.");
                }
            } catch (error) {
