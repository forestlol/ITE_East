            ...
            <div class="col-lg-4 section-container">
                ...
                <div class="console-box">
                    ...
                    <div v-for="device in toggleDevices" :key="device.name" class="toggle-switch mb-3">
                        ...
                        <span>{{ device.isOnline ? 'Close' : 'Open' }}</span>
                    </div>
                    ...
                    <div class="toggle-switch mb-4">
                        ...
                        <span>{{ fans[0].isOn ? 'Close' : 'Open' }}</span>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    data() {
        return {
            ...
            toggleDevices: [
                { name: 'MDU 3', isOnline: false, deviceEUI: '24E124756E049153', top: '41%', left: '57%' },  // Initially ON
                { name: 'MDU 4', isOnline: false, deviceEUI: '24E124756E049154', top: '25%', left: '63%' },  // Initially ON
    ...
    methods: {
        ...
        async sendAirconState(state, airconIndex) {
            const apiUrl = `https://aircon.rshare.io/aircon/${airconIndex + 2}`;
